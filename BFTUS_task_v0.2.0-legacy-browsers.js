...
function post_response_holdRoutineBegin(snapshot) {
  return async function () {
    ...
    post_response_holdComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function reward_prepRoutineBegin(snapshot) {
  return async function () {
    ...
    reward_prepComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function reward_revealRoutineBegin(snapshot) {
  return async function () {
    ...
    reward_revealComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function break_restRoutineBegin(snapshot) {
  return async function () {
    ...
    break_restComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
